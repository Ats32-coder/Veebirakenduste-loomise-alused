...
function App() {
  ...
  // erinvead elemendid omavahel seotud on
  ...
  // ja kuidas need on paigutatud lehel. See võib aidata teil mõista,
    ...
    <h1 id='Dom-Title'>
      {username === "" ? "Mis on DOM!" : username}
        ...
        <p>
          ...
          kuhu React rakendus renderdatakse. Kui React takendus käivitub,
